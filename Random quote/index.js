...
function myFunction() {
    document.getElementById("quotes").style.background = "black";
    document.getElementById("quotes").style.color = "red";
    document.getElementById("quotes").style.border = "5px solid green";
    document.getElementById("quotes").style.fontSize = "20px";
}
function myFunction1() {
    document.getElementById("quotes").style.background = "red";
    document.getElementById("quotes").style.color = "black";
    document.getElementById("quotes").style.border = "5px solid blue";
    document.getElementById("quotes").style.fontSize = "20px";
}
function myFunction2() {
    document.getElementById("quotes").style.background = "yellow";
    document.getElementById("quotes").style.color = "blue";
    document.getElementById("quotes").style.border = "5px solid orange";
    document.getElementById("quotes").style.fontSize = "20px";
}
function myFunction3() {
    document.getElementById("quotes").style.background = "blue";
    document.getElementById("quotes").style.color = "orange";
    document.getElementById("quotes").style.border = "5px solid yellow";
    document.getElementById("quotes").style.fontSize = "20px";
}